...
class MootseRunner():
    ...
    def __init__(self, path) -> None:
        ...
        login_response = session.post("https://mootse.telecom-st-etienne.fr/login/index.php")
        ...
        session.post("https://mootse.telecom-st-etienne.fr/login/index.php", data=login_data)
